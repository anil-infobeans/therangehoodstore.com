...
define('BOX_REVIEWS_WRITE_REVIEW', '&Eacute;crire une critique sur ce produit');
...
define('BOX_SHOPPING_CART_EMPTY', 'articles');
...
define('BOX_INFORMATION_FAQ', 'Questions Fréquentes');
...
define('ENTRY_COMPANY_TAX_ID', 'numéro d\'identification fiscale Société:');
define('ENTRY_COMPANY_TAX_ID_ERROR', '');
define('ENTRY_COMPANY_TAX_ID_TEXT', '');
define('ENTRY_CUSTOMERS_GROUP_NAME', 'Les clients du Groupe');
define('ENTRY_CUSTOMERS_GROUP_NAME_ERROR', 'S\'il vous plaît sélectionnez votre groupe de clients');
define('ENTRY_CUSTOMERS_GROUP_NAME_TEXT', '*');
define('ENTRY_CUSTOMERS_GROUP_NAME_SELECT', 'S\'il vous plaît sélectionnez');
...
define('ENTRY_EMAIL_ADDRESS_ERROR', 'Votre adresse courriel doit avoir un minimum de ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' caract&egrave;res.');
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Votre adresse courriel ne semble pas valide - veuillez faire les corrections n&eacute;cessaires.');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Votre adresse courriel existe d&eacute;j&agrave; dans nos enregistrements - veuillez vous identifiez avec cette adresse ou cr&eacute;er un nouveau compte avec une autre adresse courriel.');
...
define('ENTRY_STATE', 'Province ou Région&nbsp;:');
define('ENTRY_STATE_ERROR', 'Votre province ou votre r&eacute;gion doit avoir un minimum de ' . ENTRY_STATE_MIN_LENGTH . ' caract&egrave;res.');
define('ENTRY_STATE_ERROR_SELECT', 'Veuillez s&eacute;lectionner une province ou une r&eacute;gion dans la liste d&eacute;roulante des provinces et des r&eacute;gions.');
...
define('TEXT_CCVAL_ERROR_INVALID_DATE', 'La date d\'expiration de la carte de crédit est invalide. Veuillez vérifier la date et essayer à nouveau.');
define('TEXT_CCVAL_ERROR_INVALID_NUMBER', 'Le numéro de carte de crédit est invalide. Veuillez vérifier le numéro et essayer à nouveau');
define('TEXT_CCVAL_ERROR_UNKNOWN_CARD', 'Les quatre premiers chiffres saisis sont : %s. Si ce nombre est correct, nous n\'acceptons pas ce type de carte de crédit. S\'il ne l\'est pas, veuillez essayer à nouveau.');
...
*/
define('FOOTER_TEXT_BODY', 'Copyright &copy; 2008.&nbsp;<a href="http://www.choco-mango.com" target="_blank">Choco-Mango</a><br><a href="#">Confidentialité</a>&nbsp;-&nbsp;<a href="#">Conditions de vente</a>');


define('TEXT_EXTRA_IMAGES', 'D\'AUTRES VUES :');

define('TEXT_PRODUCT_DESCRIPTION', 'DESCRIPTION :');

define('TEXT_PRODUCT_PRICE', 'Prix :');
// BOF edit pages 
define('BOX_HEADING_PAGES', 'Information');
// EOF edit pages
define('TEXT_SEARCH', 'Tapez les mots clés');
define('TEXT_TELL_A_FRIEND', 'Click here to Send the link to your friend');
define('HEADING_TITLE__PRODUCT_NEW', 'Cliquez ici pour envoyer le lien à un ami');
define('FLASH', 'banner1_fr');
define('TEXT_PRODUCT_DIMENSIONS', 'Dimensions: ');
define('TEXT_PRODUCT_LENGTH', 'Longueur:');
define('TEXT_PRODUCT_WIDTH', 'Largeur:');
define('TEXT_PRODUCT_DEPTH', 'Profondeur:');

define('PLAYLIST', 'Playlist');
define('CASTING', 'Casting');
define('VIDEOS', 'Vidéos');
define('VIEWMORE', 'Voir plus');
define('NOTIFICACIONESENRIQUE', 'Montant total T.T.C.<br>BPOST, 3 - 4 jours ouvrés<br>Paiment via VISA, MASTERCARD, AMEX, DISCOVER, PAYPAL');
?>
