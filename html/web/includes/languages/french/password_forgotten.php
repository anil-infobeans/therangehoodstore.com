...
define('TEXT_MAIN', 'Si vous avez oubli&eacute; votre mot de passe, saisissez ci-dessous votre adresse courriel et nous vous enverrons un message avec votre nouveau mot de passe.');

define('TEXT_NO_EMAIL_ADDRESS_FOUND', 'Erreur&nbsp;: L\'adresse courriel n\'est pas r&eacute;pertori&eacute;e chez nous, veuillez essayer &agrave; nouveau.');
