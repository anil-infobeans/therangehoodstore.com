...
define('FORM_FIELD_FRIEND_EMAIL', 'L\'adresse courriel de votre ami&nbsp;:');
...
define('ERROR_TO_ADDRESS', 'Erreur&nbsp;r: L\'adresse courriel de votre ami doit &ecirc;tre une adresse courriel valide.');
define('ERROR_FROM_NAME', 'Erreur&nbsp;: Votre nom ne peut pas &ecirc;tre vide.');
define('ERROR_FROM_ADDRESS', 'Erreur&nbsp;: Votre adresse courriel doit &ecirc;tre une adresse courriel valide.');
?>
