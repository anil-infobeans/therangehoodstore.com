...
define('ENTRY_CUSTOMERS_GROUP_NAME', 'Customers Group');
define('ENTRY_CUSTOMERS_GROUP_NAME_ERROR', 'Please select your customers group');
define('ENTRY_CUSTOMERS_GROUP_NAME_TEXT', '*');
define('ENTRY_CUSTOMERS_GROUP_NAME_SELECT', 'Please select');
...
define('IMAGE_BUTTON_CONFIRM_ORDER_2', 'Go to Paypal');
...
define('TEXT_EXTRA_IMAGES', 'OTHER VIEWS :');
...
// EOF edit pages
define('TEXT_SEARCH', 'Write the keywords');
define('TEXT_TELL_A_FRIEND', 'Click here to Send the link to your friend');
define('HEADING_TITLE__PRODUCT_NEW', 'New Products');
define('FLASH', 'banner1_en');
define('TEXT_PRODUCT_DIMENSIONS', 'Dimensions: ');
define('TEXT_PRODUCT_LENGTH', 'Length:');
define('TEXT_PRODUCT_WIDTH', 'Width:');
define('TEXT_PRODUCT_DEPTH', 'Depth:');

define('PLAYLIST', 'Playlist');
define('CASTING', 'Casting');
define('VIDEOS', 'Videos');
define('VIEWMORE', 'View more');
define('NOTIFICACIONESENRIQUE', 'Order amount (incl. TAX/VTA)<br>BPOST, 3 - 4 working days<br>Billing through VISA, MASTERCARD, AMEX, DISCOVER, PAYPAL<br>');
define('TEXT_PASSWORD_FORGOTTEN', 'Remember your password');

			// gc_code box text in includes/boxes/gc_code_entry.php
			define('BOX_HEADING_GC_CODE', 'Gift Certificate');
			define('BOX_GC_CODE_TEXT', 'Enter your Gift Certificate Code here. Your Gift Certificate will be redeemed at checkout.');
			
						define('ENTRY_EMAIL_TEXT', '*');
			//Gift Certificate Modifications START
			define('GC_TOTAL','Gift Certificate Value Applied');
			define('BOX_GC_CODE_TEXT', 'Enter your Gift Certificate Code here. Your Gift Certificate will be redeemed at checkout.');
			global $gc;
			global $gc_code;
			global $gc_redeemed;
...
define('certicatecode', 'HAVE A GIFT CERTIFICATE CODE?');
define('commentorder', 'only one code may be used per order');
define('messagegift', 'You will receive your Gift Certificate Code in the next 24 hours');
define('viewcertificate', 'View your Gift Certificate Code');
?>
