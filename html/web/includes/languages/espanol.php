...
define('BOX_HEADING_TELL_A_FRIEND', 'Cuéntalo');
...
define('ENTRY_COMPANY_TAX_ID', 'NIF/CIF:');
define('ENTRY_COMPANY_TAX_ID_ERROR', '');
define('ENTRY_COMPANY_TAX_ID_TEXT', '');
define('ENTRY_CUSTOMERS_GROUP_NAME', 'Tipo de Cliente');
define('ENTRY_CUSTOMERS_GROUP_NAME_ERROR', 'Por favor seleccione su tipo de cliente');
define('ENTRY_CUSTOMERS_GROUP_NAME_TEXT', '*');
define('ENTRY_CUSTOMERS_GROUP_NAME_SELECT', 'Seleccione');
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Su dirección de E-Mail no parece v&aacute;lida - por favor haga los cambios necesarios.');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Su dirección de E-Mail ya figura entre nuestros clientes - puede entrar a su cuenta con esta dirección o crear una cuenta nueva con una direcci&oacute;n diferente.');
...
define('IMAGE_BUTTON_CONFIRM_ORDER_2', 'Ir al sitio de pago PAYPAL');
...
define('TEXT_EXTRA_IMAGES', 'Más Imagenes :');

define('TEXT_PRODUCT_DESCRIPTION', 'Descripción :');

define('TEXT_PRODUCT_PRICE', 'Precio :');
// BOF edit pages 
define('BOX_HEADING_PAGES', 'Información');
// EOF edit pages
define('TEXT_SEARCH', 'Escriba aquí las palabras claves');
define('TEXT_TELL_A_FRIEND', 'Click aquí para enviar el link a un amigo');
define('HEADING_TITLE__PRODUCT_NEW', 'Novedades');
define('FLASH', 'banner1_es');
define('TEXT_PRODUCT_DIMENSIONS', 'Dimensiones: ');
define('TEXT_PRODUCT_LENGTH', 'Largo:');
define('TEXT_PRODUCT_WIDTH', 'Ancho:');
define('TEXT_PRODUCT_DEPTH', 'Alto:');
define('PLAYLIST', 'Lista de Canciones');
define('CASTING', 'Casting');
define('VIDEOS', 'Videos');
define('VIEWMORE', 'Ver más');
define('NOTIFICACIONESENRIQUE', 'Importe del pedido (inc. IVA)<br>BPOST, 3 - 4 dias laborables<br>Pagos via VISA, MASTERCARD, AMEX, DISCOVER, PAYPAL');
define('TEXT_PASSWORD_FORGOTTEN', 'He olvidado mi clave');

			// gc_code box text in includes/boxes/gc_code_entry.php
			define('BOX_HEADING_GC_CODE', 'Tarjeta de Regalo');
			define('BOX_GC_CODE_TEXT', 'Ingresa aquí el código de Tarjeta de Regalo. Tu Tarjeta de Regalo será usado en la compra.');
			
						define('ENTRY_EMAIL_TEXT', '*');
			//Gift Certificate Modifications START
			define('GC_TOTAL','Valor del Tarjeta de Regalo aplicado');
			define('BOX_GC_CODE_TEXT', 'Ingresa tu codigo de Tarjeta de Regalo aqui. Tu Enter your Gift Certificate Code here. Tu Tarjeta de Regalo será usado en la compra.');
			global $gc;
			global $gc_code;
			global $gc_redeemed;
			global $gc_prod;
			global $gc_price;
			//Gift Certificate Modifications END
...
define('certicatecode', 'SI TIENES EL CÓDIGO DE UNA TARJETA DE REGALO');
define('commentorder', 'Escribe aquí el código');
define('messagegift', 'Recibirás el código de la Tarjeta de Regalo dentro de las 24 horas.');
define('viewcertificate', 'Ver el código de la Tarjeta de Regalo');
?>
