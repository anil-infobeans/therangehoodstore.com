...
define('TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'to confirm this order.');
			//---Gift Certificate Modification//
			define('GIFT_CERTIFICATE_PAYMENT_METHOD_TEXT', 'Your gift certificate has covered the entire cost!');
			define('GC_MESSAGE', 'Gift Certificate Message');
