...
define('MINIMUM_ORDER_NOTICE', "The minimun order for the product %s is %d , the shopping cart has been updated to show a real order");
define('PACK_ORDER_NOTICE', "The packs for the product %s are %d , the shopping cart has been updated to show a real order");
?>