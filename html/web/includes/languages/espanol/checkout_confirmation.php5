...
define('HEADING_TITLE', 'Confirmación de compra ');
...
define('HEADING_WARNING', 'Nota.- "Hasta aquí usted puede hacer alguna variación en su pedido... al pasar a la siguiente página su pedido será ingresado en nuestros registros y sólo debe proceder a pagar"');
?>
