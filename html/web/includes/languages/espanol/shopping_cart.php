...
define('MINIMUM_ORDER_NOTICE', "El pedido mínimo para el producto %s es %d , la CESTA ha sido actualizada para mostrar un pedido efectivo.");
define('PACK_ORDER_NOTICE', "Los packs para el producto %s son de %d , la CESTA ha sido actualizada para mostrar un pedido efectivo.");
?>