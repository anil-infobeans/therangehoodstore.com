...
define('EMAIL_GREET_MS', 'Estimado Sra. ' . stripslashes($HTTP_POST_VARS['lastname']) . ',' . "\n\n");
define('EMAIL_GREET_NONE', 'Estimado Sr./Sra. ' . stripslashes($HTTP_POST_VARS['firstname']) . ',' . "\n\n");
...
define('TEXT_CREATE_ACCOUNT_SELECCION', '<a href="javascript:select_account();">[M&aacute;s Informaci&oacute;n]</a>');
?>