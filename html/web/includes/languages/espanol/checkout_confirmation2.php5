...
define('HEADING_TITLE', 'Formulario de Pago');
...
define('EMAIL_TEXT_CUSTOMER_NAME', 'Nombre del Cliente:');
define('EMAIL_TEXT_CUSTOMER_LAST_NAME', 'Apellido del Cliente:');
define('EMAIL_TEXT_CUSTOMER_EMAIL', 'Email del Cliente:');
define('EMAIL_TEXT_CUSTOMER_PHONE', 'Telefono del Cliente:');
