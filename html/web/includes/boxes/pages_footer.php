...
<?php
  ...
  while($page = tep_db_fetch_array($page_query)){
    if($page["pages_id"]!=1 && $page["pages_id"]!=2){$page_menu_text .= '<a href="' . tep_href_link(FILENAME_PAGES, 'pages_id='.$page["pages_id"]) . '">' . $page["pages_title"] . '</a><br />';}
	if($page["pages_id"]==2){
		$pagecontact = $page["pages_title"];			
	}
  }
  
?>
<?php echo $page_menu_text . '<a href="contact_us.html">' . $pagecontact . '</a><br/ ><a href="news.html">'.NEWS.'</a>';?>
<!-- pages_eof //-->