...
// class methods
    function quote($method = '') {
      ...
      $this->quotes = array('id' => $this->code,
                            ...
                            'methods' => array(array('id' => $this->code,
                                                     ...
                                                     'cost' => MODULE_SHIPPING_FREE_COST)));
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Free Shipping', 'MODULE_SHIPPING_FREE_STATUS', 'True', 'Do you want to offer free rate shipping?', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_SHIPPING_FREE_SORT_ORDER', '0', 'Sort order of display.', '6', '0', now())");
    }
    ...
    function keys() {
      return array('MODULE_SHIPPING_FREE_STATUS', 'MODULE_SHIPPING_FREE_SORT_ORDER');
    }
  }
?>
