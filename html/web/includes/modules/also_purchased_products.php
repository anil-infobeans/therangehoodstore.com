...
*/
  ...
  if (isset($HTTP_GET_VARS['products_id'])) {
	...
	if ($num_products_ordered > 0) {
	    echo '<table cellpadding="0" cellspacing="0" border="0" height="90" width="100%">
        <tr>
        <td style="background-image:url(images/fondoH1a.png)" width="10">&nbsp;
        </td><td style="background-image:url(images/fondoH1b.png)"><div style="text-align:center" >';
		echo '<h1>Clientes que compraron este producto, también han comprado</h1>';
		echo '</div></td><td style="background-image:url(images/fondoH1c.png)" width="10">&nbsp;
        </td>
        </tr>
        </table>';
	}
