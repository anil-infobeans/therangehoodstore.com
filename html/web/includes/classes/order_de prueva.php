...
global $sppc_customer_group_id;
  ...
  $customer_group_id = '0';
   ...
   if ($customer_group_id != '0'){
   $orders_customers_groups_tax_rates_query = tep_db_query("select tr.tax_rate, tr.tax_description from " . TABLE_TAX_RATES . " tr inner join " . TABLE_CUSTOMERS_GROUPS_TAX_RATES_EXEMPT . " te on tr.tax_rates_id = te.tax_rates_id where te.customers_group_id = '". $customer_group_id . "'");
