                  ...
                  <tr>
                    <td><table border="0" cellspacing="0" cellpadding="2" width="100%">
                      <tr>
                        ...
                        <td class="main" align="left"><?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS_WRITE, tep_get_all_get_params()) . '">' . tep_image_button('button_write_review.gif', IMAGE_BUTTON_WRITE_REVIEW) . '</a>'; ?></td>
                        <td width="10"><?php echo tep_draw_separator('pixel_trans.gif', '10', '1'); ?></td>
						<td class="main" width="155">
...
<div style="position:absolute; z-index:20; width:164px; margin-left:-82px">
<script language="javascript"><!--
document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link(FILENAME_POPUP_IMAGE, 'pID=' . $product_info['products_id']) . '\\\')"><img src="watermark_ss.png" width="164" height="164" />' . '</a>'; ?>');
//--></script>
</div>
...
<div style="position:absolute; z-index:20; width:164px; margin-left:-5px">
<script language="javascript"><!--
document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link(FILENAME_POPUP_IMAGE, 'pID=' . $product_info['products_id']) . '\\\')"><img src="watermark_ss.png" width="164" height="164" />' . '</a>'; ?>');
//--></script>
</div>
