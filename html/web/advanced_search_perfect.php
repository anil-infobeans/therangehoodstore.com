...
function popupWindow(url) {
  window.open(url,'popupWindow','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=720,height=280,screenX=150,screenY=150,top=150,left=150')
}
//--></script>
<style type="text/css">
<!--
...
<!-- body //-->
	  <tr>
	   ...
	   <td class="tdborde" bgcolor="#FFFFFF" valign="top" width="600">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="height:100%">
			  <tr>
						...
						<td width="100%" height="100%" valign="top" style="background:url(images/r-t-dr.png) repeat-x; padding: 17px 11px 15px 19px">
							<table width="100%" style="height:22px" cellspacing="0" cellpadding="0" border="0">
							  <tr>
								...
								<td class="h_r_text" width="100%" height="100%" valign="top"><strong><?=HEADING_TITLE_1?></strong><br>
								</td>
      ...
      <tr>
		...
		$option_values_list[$count] = array('id' => '', 'text' => '');
		    ...
		    $option_values_list[++$count] = $option_values;
                ...
                echo tep_draw_pull_down_menu($attributes['products_options_id'], $option_values_list); ?>
                </td>
              </tr><?php
			  }
