<?php
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_DEFINE_FAQ);

  $breadcrumb->add(NAVBAR_TITLE, tep_href_link(FILENAME_DEFINE_FAQ));
?>
	...
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><?php require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_EDIT_FAQ); ?></td>
          </tr>
        </table></td>
      </tr>
      <tr>
