...
<!-- body //-->
	  ...
	  <tr>
		<td class="tdborde" valign="top" width="181" height="100%" style="height:100%; background:url(images/fondobarra.jpg) no-repeat"><?php require(DIR_WS_INCLUDES . 'column_left.php'); ?></td>
	   <td class="tdborde"  valign="top" width="600">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" style="height:100%" class="content">
			  <tr>
				<td width="100%" height="100%" valign="top">
					<table width="100%" style="height:100%" cellspacing="0" cellpadding="0" border="0">
					  <tr>
						<td width="100%" height="100%" valign="top" style="background:url(images/r-t-dr.jpg) no-repeat; padding: 17px 11px 15px 19px">
...
<script language="javascript"><!--
document.write('<?php echo '<a href="javascript:popupWindow(\\\'' . tep_href_link(FILENAME_POPUP_IMAGE, 'pID=' . $product_info['products_id']) . '\\\')">' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], addslashes($product_info['products_name']), PRODUCT_IMAGE_WIDTH, PRODUCT_IMAGE_HEIGHT, 'hspace="0" vspace="0" style="border:1px solid #DADADA"') . '<br>' . '</a>'; ?>');
//--></script>
<noscript>
<?php echo '<a href="' . tep_href_link(DIR_WS_IMAGES . $product_info['products_image']) . '" target="_blank">' . tep_image(DIR_WS_IMAGES . $product_info['products_image'], $product_info['products_name'], PRODUCT_IMAGE_WIDTH, PRODUCT_IMAGE_HEIGHT, 'hspace="0" vspace="0" style="border:1px solid #DADADA "') . '<br>' . '</a>'; ?>
</noscript>
</td>
<td align="left" class="main">
<strong class="pr_text"><?php echo TEXT_PRODUCT_PRICE; ?></strong><img alt="" src="images/spacer.gif" width="7" height="1"><span class="pr1_text"><?=$products_price?></span><br>
<?php
		//Minimum quantity code
	if (tep_not_null($product_info['minorder']) ) {
      echo '<br><strong class="pr_text">Pedido Mínimo: ' . '</strong><span class="pr1_text">' .$product_info['minorder'] . '</span>'.'<br><br style="line-height:14px;">' .'<strong class="pr_text">Packs: ' . '</strong>&nbsp;de&nbsp;<span class="pr1_text">' . $product_info['minorder'] . '</span>&nbsp;en&nbsp;<span class="pr1_text">' . $product_info['minorder'] . '<br><br style="line-height:7px;">';
    }
	//End: Minimum quantity code
	?>
<br style="line-height:7px;"> 
<strong class="pr_text"><?php echo TEXT_ENTER_QUANTITY . tep_draw_input_field('quantity','', 'size="6"'); ?></strong><br>
<br style="line-height:7px;">
<?php echo tep_draw_hidden_field('products_id', $product_info['products_id']) . tep_image_submit('button_in_cart.gif', IMAGE_BUTTON_IN_CART); ?>&nbsp;&nbsp;
<?php echo '<a href="' . tep_href_link(FILENAME_PRODUCT_REVIEWS, tep_get_all_get_params()) . '">' . tep_image_button('button_reviews.gif', IMAGE_BUTTON_REVIEWS) . '</a>'; ?><br><br>

<a href="login.php"><img src="images/especial.png"></a></td>
</tr>
<tr>
...
<br>
                                    ...
                                    <br><br>
<?php echo stripslashes($product_info['products_description']); ?><br></td>
						      </tr>
							</table>
	<table cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
...
<?php        }
?>
              <td width="426" align="left" valign="top"><br>
<br>&nbsp;<?php echo $tmp_html;  ?></td>
            </tr>
<?php
            break;
