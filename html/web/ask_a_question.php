							...
							<table width="100%" style="height:22px" cellspacing="0" cellpadding="0" border="0">
							  <tr>
								<td class="h_r_text" height="100%" valign="top" width="100%">
									<strong><?php echo sprintf(HEADING_TITLE, $product_info['products_name']); ?></strong><br>
								</td>
							  </tr>
                              <tr>
                              <td><br><br>

                              <?php echo tep_image(DIR_WS_IMAGES . $product_info['products_image'], $product_info['products_name'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT,'style="border:1px solid #D2D7DF"'); ?>
                              </td>
                              </tr>
							</table>
              ...
              <tr class="infoBoxContents">
                <td><table border="0" cellspacing="0" cellpadding="2">
                  ...
                  <tr>
                   ...
                   <tr>
                    <td class="main"><?php echo FORM_FIELD_CUSTOMER_TELEPHONE; ?></td>
                    <td class="main"><?php echo tep_draw_input_field('from_telephone'); ?></td>
                  </tr>
                </table></td>
              </tr>
            </table></td>
