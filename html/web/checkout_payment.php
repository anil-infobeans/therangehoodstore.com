...
// verify the selected billing address
  ...
  $order = new order;
			...
			// if the purchase is a gift certificate and the
			// shipping address has no email address, go back to
			// checkout_shipping.php
			if(strlen($gc_prod)>0 && strlen($order->delivery['email_address'])==0){
				tep_redirect(tep_href_link(FILENAME_CHECKOUT_SHIPPING, '', 'SSL'));
			}
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
              <tr>
                <td>                <div style="background-color:#FFEA95; padding:20px;">
                <b><?php echo certicatecode . '</b><br>'. commentorder . '</b><br>';?>
