...
$partir = explode(' ',tep_db_datetime());

$partira = explode('-', $partir[0]);

$partirb = explode(':', $partir[1]);



echo tep_db_datetime();



$realtimeserver =  mktime($partirb[0],$partirb[1],$partirb[2],$partira[1],$partira[2],$partira[0]);



$xx_mins_ago = ($realtimeserver - 900);
...
<?php
  ...
  while ($whos_online = tep_db_fetch_array($whos_online_query)) {
    ...
    $time_online = ($realtimeserver - $whos_online['time_entry']);
