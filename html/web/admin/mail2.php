...
<?php
  ...
  if ( ($HTTP_GET_VARS['action'] == 'send_email_to_user') && ($HTTP_POST_VARS['customers_email_address']) && (!$HTTP_POST_VARS['back_x']) ) {
    ...
    // MaxiDVD Added WYSIWYG HTML Area Box + Admin Function v1.5 Email HTML
...
<title><?php echo TITLE . ' - ' . HEADING_TITLE . ' - Mode: ' .  HTML_AREA_WYSIWYG_BASIC_EMAIL . ' - HTML Status: ' . HTML_AREA_WYSIWYG_DISABLE_EMAIL;?></title>
...
?>
                ...
                </table><?php if (HTML_AREA_WYSIWYG_DISABLE_EMAIL == 'Disable') {echo(TEXT_EMAIL_BUTTON_HTML);

                 } else { echo(TEXT_EMAIL_BUTTON_TEXT); } ?></td>
...
?>
  ...
  <?php if (HTML_AREA_WYSIWYG_DISABLE_EMAIL == 'Disable') {include ("comment_email_bar.php");} else { ?>

    <script language="JavaScript1.2" defer>

    // MaxiDVD Added WYSIWYG HTML Area Box + Admin Function v1.6.5 Email HTML
