...
/*      $specials_array = array();
    ...
    $specials_query = tep_db_query("select p.products_id, p.products_image, s.customers_group_id from " .  TABLE_PRODUCTS . " p, " . TABLE_SPECIALS . " s where s.products_id = p.products_id");
...
if($specials['customers_group_id'] != 0){

  $scustomer_group_price_query = tep_db_query("select customers_group_price from " . TABLE_PRODUCTS_GROUPS . " where products_id = '" . $specials['products_id']. "' and customers_group_id =  '" . $specials['customers_group_id'] . "'");
...
<td  class="dataTableContent" align="left" width="25%"><?php echo tep_image2(DIR_WS_IMAGES . $specials['products_image'], $specials['products_name'], '48', '48','') .'&nbsp;'. $specials['products_name']; ?></td>

<td  class="dataTableContent" align="right" width="25%"><span class="oldPrice"><?php echo $currencies->format($specials['products_price']); ?></span> <span class="specialPrice"><?php echo $currencies->format($specials['specials_new_products_price'])." (".$all_groups[$specials['customers_group_id']].")"; ?></span></td>
