      ...
      <tr bgcolor="#000000">
        ...
        <td><table border="0" width="600" height="440" cellspacing="0" cellpadding="0">
          ...
          <tr bgcolor="#ffffff" height="50">
            ...
            <td align="right" class="text" nowrap><?php echo '<a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . HEADER_TITLE_ADMINISTRATION . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="' . tep_catalog_href_link() . '">' . HEADER_TITLE_ONLINE_CATALOG . '</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="http://www.tienda10.es" target="_blank">' . HEADER_TITLE_SUPPORT_SITE . '</a>'; ?>&nbsp;&nbsp;</td>
...
<?php
  ...
  $contents[] = array('params' => 'class="infoBox"',
                      ...
                      'text'  => '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_SUPPORT_SITE . '</a><br>' .

                                 '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_SUPPORT_FORUMS . '</a><br>' .

                                 '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_MAILING_LISTS . '</a><br>' .

                                 '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_BUG_REPORTS . '</a><br>' .

                                 '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_FAQ . '</a><br>' .

                                 '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_LIVE_DISCUSSIONS . '</a><br>' .

                                 '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_CVS_REPOSITORY . '</a><br>' .

                                 '<a href="http://www.tienda10.es" target="_blank">' . BOX_ENTRY_INFORMATION_PORTAL . '</a>');
