...
?>
                ...
                <td class="dataTableContent" align="center"><?php echo tep_image2(DIR_WS_IMAGES . $products_extra_image['products_image'], $products_extra_image['products_name'], '48', '48'); ?></td>

                <td class="dataTableContent"><?php echo $products_extra_image['products_extra_image']; ?></td>

                <td class="dataTableContent" align="center"><?php echo tep_image2(DIR_WS_IMAGES . $products_extra_image['products_extra_image'], $products_extra_image['products_extra_image_name'], '48', '48'); ?></td>

                <td class="dataTableContent" align="right"><?php if ($products_extra_image['products_extra_images_id'] == $pId) { echo tep_image(DIR_WS_IMAGES . 'icon_arrow_right.gif', ''); } else { echo '<a href="' . tep_href_link(FILENAME_PRODUCTS_EXTRA_IMAGES, 'page=' . $page . '&pID=' . $pId) . '">' . tep_image(DIR_WS_IMAGES . 'icon_info.gif', IMAGE_ICON_INFO) . '</a>'; } ?>&nbsp;
  ...
  switch ($action) {
    ...
    case 'delete':
      ...
      if (isset($pId)) {
        ...
        $contents[] = array('align' => 'center', 'text' => '<br>' . tep_image2(DIR_WS_IMAGES .$pInfo -> products_extra_image, $pInfo -> products_model, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT));
