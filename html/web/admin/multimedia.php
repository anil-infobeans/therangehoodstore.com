...
<?php echo  '<a href="' . tep_href_link(FILENAME_MUSIC, '', 'NONSSL') . '" class="menuBoxContentLink" target="_blank">' . BOX_TAXES_MUSIC . '</a><br>';?>

<?php echo  '<a href="' . tep_href_link(FILENAME_CASTING, '', 'NONSSL') . '" class="menuBoxContentLink" target="_blank">' . BOX_TAXES_CASTING . '</a><br>';?>

<?php echo  '<a href="' . tep_href_link(FILENAME_VIDEOS, '', 'NONSSL') . '" class="menuBoxContentLink" target="_blank">' . BOX_TAXES_VIDEOS . '</a><br>';?>

<?php echo  '<a href="' . tep_href_link(FILENAME_UPLOADPDF, '', 'NONSSL') . '" class="menuBoxContentLink" target="_blank">' . BOX_UPLOADPDF . '</a><br>';?>
