      ...
      <tr>
        ...
        <td width="100%"><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="right" class="smallText2"><table border="0" width="100%" cellspacing="0" cellpadding="0">
        ...
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td valign="top"><table border="0" width="100%" cellspacing="0" cellpadding="2">
              ...
              <td class="dataTableHeadingContent"><?php echo HEADING_TITLE_SEARCH; ?></td>
...
?>
				...
				<td class="dataTableContent"><?php echo '<a href="' . tep_href_link(FILENAME_ORDERS, tep_get_all_get_params(array('oID', 'action')) . 'oID=' . $orders['orders_id'] . '&action=edit') . '">' . tep_image(DIR_WS_ICONS . 'preview.gif', ICON_PREVIEW) . '&nbsp;' . $orders['orders_id'].'</a>'; ?></td>
