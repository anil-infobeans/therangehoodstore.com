...

{
	...
	*/
...

	{
		...
		$file_dump .= "/*!40101 SET @OLD_CHARACTER_SET_CLIENT=@@CHARACTER_SET_CLIENT */" . ";\n";

		$file_dump .= "/*!40101 SET @OLD_CHARACTER_SET_RESULTS=@@CHARACTER_SET_RESULTS */" . ";\n";

		$file_dump .= "/*!40101 SET @OLD_COLLATION_CONNECTION=@@COLLATION_CONNECTION */" . ";\n";

		$file_dump .= "/*!40103 SET @OLD_TIME_ZONE=@@TIME_ZONE */;" . ";\n";

		$file_dump .= "/*!40103 SET TIME_ZONE='+00:00' */" . ";\n";

		$file_dump .= "/*!40014 SET @OLD_UNIQUE_CHECKS=@@UNIQUE_CHECKS, UNIQUE_CHECKS=0 */" . ";\n";

		$file_dump .= "/*!40014 SET @OLD_FOREIGN_KEY_CHECKS=@@FOREIGN_KEY_CHECKS, FOREIGN_KEY_CHECKS=0 */" . ";\n";

		$file_dump .= "/*!40101 SET @OLD_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO' */" . ";\n";

		$file_dump .= "/*!40111 SET @OLD_SQL_NOTES=@@SQL_NOTES, SQL_NOTES=0 */" . ";\n\n\n";		
		...
		$risultato = mysql_list_tables($this->db_name);
	...
	*/
...

	{
...

		{
			...
			$file = fopen ( $this->dir . $this->filename , "w+" );

			// Write sql backup

			fwrite ( $file , $file_dump );
	...
	*/
...

	{
		...
		//bloquea tablas para reescibrir sobre ellas
		...
		//desbloquea tablas para yano reescibrir sobre ellas
