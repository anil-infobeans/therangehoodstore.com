...
?>
              ...
              <tr>
                ...
                <td class="pageHeading" colspan="11">&nbsp;<?php echo $options_values['products_options_name']; ?>&nbsp;</td>
...
?>
              ...
              <tr>
                ...
                <td colspan="9" class="pageHeading">&nbsp;<?php echo HEADING_TITLE_OPT; ?>&nbsp;&nbsp;
...
<?php
      ...
      //} else {
          ...
          $option_name = tep_db_fetch_array($option_name);
 		  ...
 		  $inputs .= '<div style="width:54px">'.$languages[$i]['code'] . ':</div>&nbsp;<input type="text" name="option_name[' . $languages[$i]['id'] . ']" size="32" value="' . $option_name['products_options_name'] . '"><br><div style="width:54px">' . TABLE_HEADING_OPT_COMMENT . ':</div>&nbsp;<input type="text" name="option_comment[' . $languages[$i]['id'] . ']" size="32" value="' . $option_name['products_options_comment'] . '"><br><br>';
...
<?php
      ...
      for ($i = 0, $n = sizeof($languages); $i < $n; $i ++) {
        ...
        $inputs .= '<div style="width:54px">'.$languages[$i]['code'] . ':</div>&nbsp;<input type="text" name="option_name[' . $languages[$i]['id'] . ']" size="32"><br><div style="width:54px">' . TABLE_HEADING_OPT_COMMENT . ':</div>&nbsp;<input type="text" name="option_comment[' . $languages[$i]['id'] . ']" size="32"><br><br>';
...
<!-- Start Clone -->
	...
	<!-- Data Start -->
        ...
        <tr><td class="pageHeading" colspan="3">Clone Product Attributes</td></tr>
