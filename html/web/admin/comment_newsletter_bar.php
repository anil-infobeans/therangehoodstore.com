...
<button class="cbutton" onClick="updateMessage('Newsletter Issue Date: <?php echo date("d-m-Y"); ?>','Order Status #');">Issue Date</button>&nbsp;

<button class="cbutton" onClick="updateMessage('\nGreetings Subscriber,\n\nWelcome to <?php echo STORE_NAME;?>\'s Monthly Newsletter\n','3');">Greetings</button>&nbsp;

<button class="cbutton" onClick="updateMessage('This Month we pack punch with all this and More\n==============================\n* Another one bites the Dust?\n* Tom Cruise remarries\n* HOT SPECIALS just for subscribers.... lala','6');">This Month</button>&nbsp;

<button class="cbutton" onClick="updateMessage('\nThank you, \n<?php echo STORE_OWNER;?>\n-----------------\nSalesmanager\n<?php echo STORE_NAME;?>\nEmail: <?php echo STORE_OWNER_EMAIL_ADDRESS;?>','6');">Email</button>&nbsp;

<button class="cbutton" onClick="updateMessage('\nVisit us today!\n<?php echo HTTP_SERVER; ?>','5');">URL</button>&nbsp;
