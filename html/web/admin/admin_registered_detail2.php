...
$query_Recordset1 = sprintf("SELECT * FROM registered_user2 WHERE id_registered_user = %s", GetSQLValueString($colname_Recordset1, "int"));
...
$ins_registered_user->setTable("registered_user2");
...
$upd_registered_user->setTable("registered_user2");
...
$del_registered_user->setTable("registered_user2");
...
$rsregistered_user = $tNGs->getRecordset("registered_user2");
...
<div class="KT_tng">
  ...
  <div class="KT_tngform">
    ...
    <input type="radio" name="RadioGroup1" value="1" <?php echo "checked"; ?>/>
