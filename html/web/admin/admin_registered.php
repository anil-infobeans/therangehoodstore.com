...
$query_Recordset1 = "SELECT * FROM registered_user ORDER BY id_registered_user DESC";
...
$query_Recordset_lang_band = "SELECT * FROM languages WHERE languages_id =".$row_Recordset1['id_language']."";

$Recordset_lang_band = mysql_query($query_Recordset_lang_band, $wa_coneccion) or die(mysql_error());

$row_Recordset_lang_band = mysql_fetch_assoc($Recordset_lang_band);

$totalRows_Recordset_lang_band = mysql_num_rows($Recordset_lang_band);
    ...
    ?>    
                ...
                <tr class="<?php echo @$cnt1++%2==0 ? "" : "KT_even"; ?>">
                  ...
                  <td><?php echo tep_image(DIR_WS_CATALOG_LANGUAGES . $row_Recordset_lang_band['directory'] . '/images/icon.gif', $row_Recordset_lang_band['directory']); ?></td>

                  <td align="right"><a class="KT_edit_link" href="admin_registered_detail.php?id_registered_user=<?php echo $row_Recordset1['id_registered_user']; ?>&amp;KT_back=1"><?php echo EDIT; ?></a> </td>
...
<span>&nbsp;</span>
          ...
          <a class="KT_additem_op_link" href="admin_registered_detail.php?KT_back=1" onclick="return nxt_list_additem(this)"><?php echo ADDNEW; ?></a> </div>
