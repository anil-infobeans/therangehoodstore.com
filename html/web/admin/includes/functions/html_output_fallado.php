...
// Output a form pull down menu
  ...
  function tep_draw_pull_down_menu($name, $values, $default = '', $parameters = '', $required = false, $multi = false) {

    global $HTTP_GET_VARS, $HTTP_POST_VARS;

	/* TAX RATES EXEMPTABLE BOC */ 

	// You MUST add the additional field to the function parameteres list above $multi = false (DO NOT LEAVE THIS OUT!)
    ...
    for ($i=0, $n=sizeof($values); $i<$n; $i++) {
	  ...
	  if (array_key_exists($values[$i]['id'],$default) || $default == $values[$i]['id']) {
  ...
  function tep_image($src, $alt = '', $width = '', $height = '', $parameters = '')
   ...
   switch ( $size[2] )
      ...
      case 2: // JPG
         ...
         imagejpeg($destImg, DIR_FS_DOCUMENT_ROOT . '/' . $newName, 90);
