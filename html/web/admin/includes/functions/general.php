...
// Text Mode
  ...
  function tep_get_products_description2($product_id, $language_id) {

    $product_query = tep_db_query("select products_description2 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description2'];

  }

  function tep_get_products_description3($product_id, $language_id) {

    $product_query = tep_db_query("select products_description3 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description3'];

  }

  function tep_get_products_description4($product_id, $language_id) {

    $product_query = tep_db_query("select products_description4 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description4'];

  }

  function tep_get_products_description5($product_id, $language_id) {

    $product_query = tep_db_query("select products_description5 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description5'];

  }  

  function tep_get_products_description6($product_id, $language_id) {

    $product_query = tep_db_query("select products_description6 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description6'];

  }

  function tep_get_products_description7($product_id, $language_id) {

    $product_query = tep_db_query("select products_description7 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description7'];

  }

  function tep_get_products_description8($product_id, $language_id) {

    $product_query = tep_db_query("select products_description8 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description8'];

  }

  function tep_get_products_description9($product_id, $language_id) {

    $product_query = tep_db_query("select products_description9 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_description9'];

  } 

  function tep_get_products_t1($product_id, $language_id) {

    $product_query = tep_db_query("select products_t1 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_t1'];

  }

  function tep_get_products_t2($product_id, $language_id) {

    $product_query = tep_db_query("select products_t2 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_t2'];

  }

  function tep_get_products_t3($product_id, $language_id) {

    $product_query = tep_db_query("select products_t3 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_t3'];

  }

  function tep_get_products_t4($product_id, $language_id) {

    $product_query = tep_db_query("select products_t4 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_t4'];

  }

  function tep_get_products_t5($product_id, $language_id) {

    $product_query = tep_db_query("select products_t5 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_t5'];

  }

  function tep_get_tags($product_id, $language_id) {

    $product_query = tep_db_query("select tags from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");
  ...
  function tep_get_products_title2($product_id, $language_id) {

    $product_query = tep_db_query("select products_title2 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title2'];

  }

  function tep_get_products_title3($product_id, $language_id) {

    $product_query = tep_db_query("select products_title3 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title3'];

  }

  function tep_get_products_title4($product_id, $language_id) {

    $product_query = tep_db_query("select products_title4 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title4'];

  }

  function tep_get_products_title5($product_id, $language_id) {

    $product_query = tep_db_query("select products_title5 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title5'];

  }

  function tep_get_products_title6($product_id, $language_id) {

    $product_query = tep_db_query("select products_title6 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title6'];

  }

  function tep_get_products_title7($product_id, $language_id) {

    $product_query = tep_db_query("select products_title7 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title7'];

  }

  function tep_get_products_title8($product_id, $language_id) {

    $product_query = tep_db_query("select products_title8 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title8'];

  }  

  function tep_get_products_title9($product_id, $language_id) {

    $product_query = tep_db_query("select products_title9 from " . TABLE_PRODUCTS_DESCRIPTION . " where products_id = '" . (int)$product_id . "' and language_id = '" . (int)$language_id . "'");

    $product = tep_db_fetch_array($product_query);



    return $product['products_title9'];
...
$thumbnail = substr($product_image['products_image'], 0, strrpos($product_image['products_image'], '.')) . '-'.PRODUCT_IMAGE_WIDTH.'x'.PRODUCT_IMAGE_HEIGHT.'.jpg';

if (file_exists(DIR_FS_CATALOG_IMAGES . $thumbnail)) {

@unlink(DIR_FS_CATALOG_IMAGES . $thumbnail);
