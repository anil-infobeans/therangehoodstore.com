...
class KT_image {
	...
	function blur($filename, $intensity = 0)
	...
	function blur_imagemagick($filename, $intensity = 0)
...

	{
        ...
        $colorr = imagecolorallocatealpha($image, 0, 0, 0, 127);

        imagefill($image, 0, 0, $colorr);
