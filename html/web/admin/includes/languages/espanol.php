...
@setlocale(LC_TIME, 'es_ES.ISO_8859-1');
 ...
 //date_default_timezone_set('Europe/Madrid'); /*rs_mdf =>usar en lugar de putenv()*/
...
define('ENTRY_CUSTOMERS_GROUP_NAME', 'Grupo de Cliente:');
...
// funcion adicional para el html texto editor

define('BOX_CATALOG_DEFINE_MAINPAGE', 'Define Página Principal');
...
define('BOX_CATALOG_CATEGORIES_PRODUCTS_EXTRA_IMAGES','Extra Imagenes'); //Added for Extra Images Contribution

define('BOX_CATALOG_DEFINE_SHIPPING', 'Envios/Devoluciones');//Added for admin/edit_shipping.php

define('BOX_CATALOG_DEFINE_PRIVACY', 'Confidencialidad');//Added for admin/edit_privacy.php

define('BOX_CATALOG_DEFINE_ABOUT_US', 'Nosotros');//Added for admin/edit_about_us.php

define('BOX_CATALOG_DEFINE_CONDITIONS', 'Condiciones de Uso');//Added for admin/edit_conditions.php

define('BOX_CATALOG_DEFINE_FAQ', 'Preguntas Frecuentes');//Added for admin/edit_faq.php

// get_1_free

define('BOX_CATALOG_GET_1_FREE', 'Conseguir 1 gratis');
...
define('BOX_CUSTOMERS_GROUPS', 'Grupo de Clientes');
...
// configuration box text in includes/boxes/information.php
...
define('BOX_INFORMATION_ABOUT_US', 'Nosotros');
...
define('ENTRY_COMPANY_TAX_ID', 'Número de Impuestos de la Empresa:');

define('ENTRY_COMPANY_TAX_ID_ERROR', '');

define('ENTRY_CUSTOMERS_GROUP_REQUEST_AUTHENTICATION', 'Poner en off para autentificación:');

define('ENTRY_CUSTOMERS_GROUP_RA_NO', 'Alerta off');

define('ENTRY_CUSTOMERS_GROUP_RA_YES', 'Alerta on');
...
define('TEXT_DISPLAY_NUMBER_OF_BANNERSREAL', 'Viendo del <b>%d</b> al <b>%d</b> (de <b>%d</b> banners)');
...
define('BOX_HEADING_PAGES', 'Editor de Página');

define('PAGES_ADD_PAGE', 'Crear Nueva Página');

define('PAGES_LIST_PAGES', 'Lista de Páginas');

// EOF edit pages	

define('TEXT_PRODUCTS_LENGTH', 'Largo:');

define('TEXT_PRODUCTS_WIDTH', 'Ancho:');

define('TEXT_PRODUCTS_DEPTH', 'Alto:');



// taxes box text in includes/boxes/multimedia.php.php

define('BOX_HEADING_MULTIMEDIA', 'Multimedia');

define('BOX_TAXES_MUSIC', 'Musica');

define('BOX_TAXES_CASTING', 'Casting');

define('BOX_TAXES_VIDEOS', 'Videos');

define('BOX_UPLOADPDF', 'Subir Pdf');
...
define('BOX_HEADING_GV_ADMIN', 'Tarjeta de Regalo');

define('BOX_GV_ADMIN_QUEUE', 'Tarjeta de Regalo en espera');

define('BOX_GV_ADMIN_MAIL', 'Email de Tarjeta de Regalo');

define('BOX_GV_ADMIN_SENT', 'Tarjeta de Regalo enviada');

define('BOX_COUPON_ADMIN','Administrador de Tarjeta de Regalo');



define('IMAGE_RELEASE', 'Usar Tarjeta de Regalo');
...
define('_SEPTEMBER', 'Setiembre');

define('_OCTOBER', 'Ocubre');
...
define('TEXT_DISPLAY_NUMBER_OF_GIFT_VOUCHERS', 'Mostrando <b>%d</b> de <b>%d</b> (a <b>%d</b> Tarjeta de Regalo)');

define('TEXT_DISPLAY_NUMBER_OF_COUPONS', 'Mostrando <b>%d</b> a <b>%d</b> (de <b>%d</b> cupones)');



define('TEXT_VALID_PRODUCTS_LIST', 'Listado de Productos');

define('TEXT_VALID_PRODUCTS_ID', 'ID Productos');
...
define('TEXT_VALID_CATEGORIES_LIST', 'Listado de Categorías');

define('TEXT_VALID_CATEGORIES_ID', 'ID Categorías');

define('TEXT_VALID_CATEGORIES_NAME', 'Nombre de Categorías');



define('BOX_BANNERSREAL', 'Banner Rotador');
