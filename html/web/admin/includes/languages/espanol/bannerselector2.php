...
define('HEADING_TITLE', 'Banner Rotativo');
...
define('TEXT_SPECIALS_GROUPS', 'Grupo de Clientes:');
...
define('TEXT_INFO_HEADING_DELETE_SPECIALS', 'Eliminar Producto del Banner Rotativo');

define('TEXT_INFO_DELETE_INTRO', '¿Seguro que desea eliminar esta producto del Banner Rotativo?');
