...
define('BOX_CATALOG_DEFINE_SHIPPING', 'Shipping');//Added for admin/edit_shipping.php

define('BOX_CATALOG_DEFINE_PRIVACY', 'Privacy');//Added for admin/edit_privacy.php

define('BOX_CATALOG_DEFINE_ABOUT_US', 'About us');//Added for admin/edit_about_us.php

define('BOX_CATALOG_DEFINE_CONDITIONS', 'Conditions');//Added for admin/edit_conditions.php

define('BOX_CATALOG_DEFINE_FAQ', 'Faq');//Added for admin/edit_faq.php
...
define('TEXT_DISPLAY_NUMBER_OF_BANNERSREAL', 'Displaying <b>%d</b> to <b>%d</b> (of <b>%d</b> zones)');
