...
define('TABLE_HEADING_PRODUCTS_IMAGE', 'Product');

define('TABLE_HEADING_PRODUCTS_IMAGE_PATH', 'Image Path (from OSC images folder)');

define('TABLE_HEADING_PRODUCTS_EXTRA_IMAGE', 'Extra Image');
...
define(ACTION_ADD_NEW_EXTRA_IMAGE, "Add New Image");
