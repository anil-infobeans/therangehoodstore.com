...
define('HEADING_TITLE', 'Banner Rotator');
...
define('TEXT_SPECIALS_GROUPS', 'Customers Group:');
...
define('TEXT_INFO_HEADING_DELETE_SPECIALS', 'Delete Banner');

define('TEXT_INFO_DELETE_INTRO', 'Are you sure you want to delete the Banner?');
