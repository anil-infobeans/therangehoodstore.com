<?php
  ...
  require(DIR_WS_LANGUAGES . $language . '/' . FILENAME_INFO_CREATE_ACCOUNT);
?>
			...
			<table width="417" style="height:462px" cellspacing="0" cellpadding="0" border="0">
			  <tr>
				<td width="100%" height="100" valign="top">
					<img alt="" src="images/logo.png" style="margin-right:23px; margin-top:27px; margin-left:14px"><br>
			  ...
			  <tr>
				<td width="100%" height="311" valign="top">
					<div class="pop_m_text" style="margin-left:12px; margin-top:15px; margin-right:14px; margin-bottom:10px">
						...
						<br style="line-height:16px;">
						<font><strong><?php echo SUB_HEADING_TITLE_4; ?></strong></font><br>
						<br style="line-height:2px;">
						<?php echo SUB_HEADING_TEXT_4; ?><br>
			  ...
			  <tr>
				<td align="center" width="100%" height="49" valign="middle">Copyright &copy;Tienda 10, 2009. Derechos Reservados</td>
			  </tr>
			</table>
		</td>
	  </tr>
