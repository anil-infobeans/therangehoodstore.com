      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
          <tr class="infoBoxContents">
            <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
			  ...
			  while ($attributes = tep_db_fetch_array($attributes_query)) {?>
                ...
                while ($option_values = tep_db_fetch_array($option_values_query)) {
				  $option_values_list[0] = array('id' => "", 'text' => "Todos");
		          $option_values_list[] = array('id' => $option_values['products_options_values_id'], 'text' => $option_values['products_options_values_name']);
                }
            ...
            <td class="smallText" align="right"><br>
