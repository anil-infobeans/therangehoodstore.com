...
<?php        
    ...
    <form action="<?php echo tep_href_link(FILENAME_GV_SEND, 'action=send&gv_no='.$HTTP_GET_VARS['gv_no'].'', 'NONSSL'); ?>" method="post"><table border="0" width="100%" cellspacing="4" cellpadding="4">
          ...
          <tr>
            ...
            <td class="main">
            <span class="pr_text"><?php echo $currencies->format(round($coupon['coupon_amount']));?></span><input name="amount" type="hidden" value="<?php echo round($coupon['coupon_amount']);?>"><input name="gv_no" type="hidden" value="<?php echo $HTTP_GET_VARS['gv_no'];?>">
