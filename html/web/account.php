...
?>
                  <tr class="moduleRow" onMouseOver="rowOverEffect(this)" onMouseOut="rowOutEffect(this)" onClick="document.location.href='<?php echo tep_href_link(FILENAME_ACCOUNT_HISTORY_INFO, 'order_id=' . $orders['orders_id'], 'SSL'); ?>'">
                    ...
                    <td class="main"><?php echo 'Nº' . $orders['orders_id']; ?></td>
...
?>
      ...
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><b><?php echo "Tarjeta de Regalo"; ?></b></td>
          </tr>
        </table></td>
      </tr>
      <tr>
	  ...
	  $coupon_search_query=tep_db_query("select * from coupon_email_track where emailed_to ='".$coupon_search1['customers_email_address']."' order by coupon_id desc");
